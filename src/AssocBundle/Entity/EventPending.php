 ...
 * EventPending
 *
 * @ORM\Table(name="eventPending")
 * @Vich\Uploadable
 * @ORM\Entity(repositoryClass="AssocBundle\Repository\EventPendingRepository")
 */
class EventPending
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="EventPending", mappedBy="eventPending")
     * @ORM\JoinColumn(onDelete="CASCADE")
     */
    private $comments;
    /**
     * @ORM\OneToMany(targetEntity="Rating", mappedBy="eventPending", cascade={"persist", "remove"})
     */
    private $ratings;
     ...
     * Add comment
     *
     * @param \AssocBundle\Entity\EventPending $comment
     *
     * @return EventPending
     */
    public function addComment(\AssocBundle\Entity\EventPending $comment)
    {
     ...
     * @param \AssocBundle\Entity\EventPending $comment
     */
    public function removeComment(\AssocBundle\Entity\EventPending $comment)
    {
