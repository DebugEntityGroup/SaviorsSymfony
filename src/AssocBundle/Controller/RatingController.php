...
class RatingController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $ratings = $em->getRepository('AssocBundle:Rating')->findAll();
    ...
    {
        $rating = new Rating();
        $form = $this->createForm('AssocBundle\Form\RatingType', $rating);
    ...
    {
        $deleteForm = $this->createDeleteForm($rating);
        $editForm = $this->createForm('AssocBundle\Form\RatingType', $rating);
