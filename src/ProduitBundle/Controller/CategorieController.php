...
class CategorieController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('categorie_show', array('nom' => $categorie->getNom()));
        }
    ...
    public function editAction(Request $request, Categorie $categorie)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('categorie_edit', array('nom' => $categorie->getNom()));
        }
    ...
    private function createDeleteForm(Categorie $categorie)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('categorie_delete', array('nom' => $categorie->getNom())))
            ->setMethod('DELETE')
            ->getForm()
            ;
    }
