...
class CategorieForumController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $categorieForums = $em->getRepository('ForumBundle:CategorieForum')->findAll();

        return $this->render('categorieforum/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('ForumBundle\Form\CategorieForumType', $categorieForum);
        ...
        return $this->render('categorieforum/new.html.twig', array(
    ...
    {
        $deleteForm = $this->createDeleteForm($categorieForum);
        $editForm = $this->createForm('ForumBundle\Form\CategorieForumType', $categorieForum);
